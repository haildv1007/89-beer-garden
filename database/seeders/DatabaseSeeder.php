...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            if ($legacyManager = Role::query()->where('code', 'manager')->first()) {
                DB::table('users')->where('role_id', $legacyManager->id)->update(['role_id' => $roles['admin']->id]);
                $legacyManager->permissions()->detach();
