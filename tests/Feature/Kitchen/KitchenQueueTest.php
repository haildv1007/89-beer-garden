...
class KitchenQueueTest extends TestCase
{
    ...
    public function test_kitchen_is_a_read_only_ticket_register_with_print_and_reprint(): void
    {
        ...
        $automaticPrint = $this->get(route('kitchen.tickets.printable', [$ticket, 'autoprint' => 1]))
            ->assertOk();
        $this->assertSame(1, substr_count($automaticPrint->getContent(), 'setTimeout(() => window.print(), 250)'));
    }
