...
if (textarea) {
    const isProduct = textarea.dataset.editorType === 'product';
        ...
        setup(editor) {
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    editor.save();
                    if (!isProduct && !editor.getContent({ format: 'text' }).trim() && !editor.getContent().includes('<img')) {
