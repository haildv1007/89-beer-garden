                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-product-cell"><img
                                            src="{{ $product->primary_image_url ?: $configuredSiteLogoUrl }}"
                                            alt="{{ $product->name }}">
                                ...
                                <td>
                                    <div class="admin-product-tags">
                                        @foreach ($product->tags as $tag)
                                            <span style="--tag-color: {{ $tag->icon_color ?: '#0b6b4f' }}; --tag-bg: {{ $tag->background_color ?: '#e8f5ef' }}">
                                                @if ($tag->icon_class)<i class="{{ $tag->icon_class }}"></i>@endif{{ $tag->name }}
                                            </span>
                                        @endforeach
                                    </div>
                                </td>
