...
Tài liệu được dùng làm tài liệu tham chiếu trước khi phân tích System
Requirements, Use Case, Database, UI/UX và Development.
...
Khi triển khai từ tài liệu này:
