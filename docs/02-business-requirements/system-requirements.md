...
Tài liệu được thiết kế làm tài liệu tham chiếu trước khi triển khai Use
Case, Database, UI/UX, Development và Testing.
...
Quá trình triển khai phải tuân thủ các nguyên tắc sau:
