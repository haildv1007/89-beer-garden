...
return [
    'employees' => [
        ...
        'edit' => '编辑员工',
        'empty' => '暂无员工。',
        'disabled_success' => '员工及关联账户已停用。',
        'disable' => '停用',
        'disable_confirm' => '确定停用此员工及关联账户吗？',
    ...
    'accounts' => [
        ...
        'create' => '创建账户',
        'created' => '关联账户已创建。',
        'already_linked' => '此员工已有账户。',
        'employee_disabled' => '无法为已停用员工创建账户。',
        'invalid_role' => '此角色不适用于员工账户。',
        'role_updated' => '角色已更新。',
    ],
    'roles' => [
        'title' => '角色与权限',
        'current' => '当前角色',
        'update' => '更新角色',
        'permissions_updated' => '权限矩阵已更新。',
        'matrix_help' => '只能授予已批准目录中的权限。',
    ...
    'bootstrap_admin' => [
        ...
        'already_exists' => '初始管理员账户已存在。',
        'created' => '初始管理员已安全创建。',
        'failed' => '无法创建管理员；未保存任何数据。',
    ],
];
