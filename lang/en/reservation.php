...
return [
    ...
    'validation' => [
        'future_time' => 'The reservation date and time must be in the future.',
        'date_not_past' => 'Please choose today or a future date.',
    ...
    'customer' => [
        ...
        'created' => 'Your reservation request has been recorded.',
        'confirmation_title' => 'Reservation request received',
        'confirmation_message' => 'Please keep the code below. The restaurant will review and confirm your request.',
        'request_details' => 'Request details',
        'empty' => 'You have no reservation requests.',
        'back' => 'Back to reservations',
        'table_not_assigned' => 'Not assigned',
        'processing_notice' => 'A reservation does not open a dining session. Staff will handle check-in and table assignment when you arrive.',
    ],
    'internal' => [
        'title' => 'Reservation management',
        'operations_lead' => 'Confirm, assign, and check in from the live reservation state.',
        'search_placeholder' => 'Search code, name, or phone',
        'all_statuses' => 'All statuses',
        'date_from' => 'From date',
        'date_to' => 'To date',
        'empty' => 'No matching reservation requests.',
        'back' => 'Back to list',
        ...
        'confirmed' => 'The reservation request has been confirmed.',
        'rejected' => 'The reservation request has been rejected.',
