...
class CompletePaymentService
{
    ...
    public function complete(Bill $bill, User $actor, string $method, ?string $reference): Payment
    {
        return DB::transaction(function () use ($bill, $actor, $method, $reference): Payment {
