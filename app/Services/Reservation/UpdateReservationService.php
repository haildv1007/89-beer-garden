...
class UpdateReservationService
{
    ...
    public function update(Reservation $reservation, array $data): Reservation
    {
        return DB::transaction(function () use ($reservation, $data): Reservation {
            ...
            $nextStatus = $locked->status === ReservationStatus::Late &&
                $arrival->addMinutes($this->settings->lateCheckInMinutes())->isFuture()
            ...
            $locked
                ...
                ->forceFill(['customer_id' => $customer->id, 'status' => $nextStatus])
                ->save();
