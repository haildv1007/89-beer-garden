...
use App\Http\Requests\POS\CancelReservationRequest;
...
class ReservationController extends Controller
{
    ...
    public function index(ReservationIndexRequest $request, RefreshLateReservationsService $lateReservations): View
    {
        $lateReservations->refresh();
    ...
    public function show(Reservation $reservation, RefreshLateReservationsService $lateReservations): View
    {
        $lateReservations->refresh();
        $reservation->refresh();
        $reservation->load([
    ...
    public function cancel(
        ...
        $service->cancel($reservation, $request->user(), $request->validated('reason'));

        return back()->with('success', 'Đã hủy yêu cầu đặt bàn.');
    }
