...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request, SecurityEventLogger $securityEvents): RedirectResponse
    {
        ...
        $securityEvents->record($request, 'login_succeeded', $request->user());

        return $this->redirectToSafeIntendedPath($request);
    }

    public function destroy(Request $request, SecurityEventLogger $securityEvents): RedirectResponse
    {
        $securityEvents->record($request, 'logout', $request->user());
        $this->logoutAndInvalidateSession($request);
